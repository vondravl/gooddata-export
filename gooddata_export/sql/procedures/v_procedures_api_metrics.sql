...
SELECT 
    ...
    'curl -X DELETE "https://micdiagnose-dev.cloud.gooddata.com/api/v1/entities/workspaces/{workspace_id}/metrics/' || metric_id || '" -H "Authorization: Bearer {bearer_token}"' AS curl_delete
