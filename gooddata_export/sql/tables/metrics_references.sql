...
--   {dataset/dataset_id} - dataset references (reference_type='dataset')
--
...
--   Dataset references -> ldm_datasets table
...
CREATE TABLE metrics_references (
    ...
    referenced_id TEXT,
    reference_type TEXT,  -- 'metric', 'attribute', 'label', 'fact', or 'dataset'
